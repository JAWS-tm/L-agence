...
userRouter.delete('/rental/:userId/:propertyId', isAuthenticated, isAdmin, userController.removeRentalAdmin);
...
userRouter.get('/rental/application', isAuthenticated, userController.getRentalApplication);
userRouter.get('/rental/application/:id', isAuthenticated, userController.getRentalApplicationById);
